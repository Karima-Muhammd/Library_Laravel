...
<div class="row">
    <div  style="  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 10px" class="col-md-6 p-5 offset-md-3 mt-5 ">
        <h2 style="font-family: 'Piedra', cursive; text-align: center; " class="text-center mb-4">{{__('Register Now')}}</h2>
        ...
        <form action="{{route('doRegister_auth')}}" METHOD="post">
            ...
            <div style="text-align: center " class="mt-3">
                ...
                <span style=" margin-top:3rem; display: block;">{{__('Have Already An Account?')}}<a style="font-family: 'Piedra', cursive;  text-decoration: none" href="{{route('Login_auth')}}"> {{__('Login Here')}}</a></span>
                <span style="display: block; margin-top: 10px"><a style="font-family: 'Piedra', cursive;font-size: 30px; color: black; text-decoration: none" href="{{route('all_books')}}">  ↩ {{__('GO Home')}} </a> </span>
            </div>
        </form>
    </div>
